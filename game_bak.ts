...
Bugs:
(1) Mouse input isn't been captured by MousePos
*/
...
mousePos,mousePosScreen,isOverlapping, mouseWasPressed,mouseWasReleased, setTouchInputEnable, keyWasPressed,setTouchGamepadAlpha,initTileCollision,setTouchGamepadAnalog,setSoundVolume,setSoundEnable, vibrate,setCanvasPixelated, setTileCollisionData, setTilesPixelated, setGravity,setCameraPos, setCameraScale, drawText,engineInit } = LittleJS;
...
class Player extends PhysicsObject {
    ...
    update() {
        ...
        // bug: mouse Pos input isn't being captured at all
        ...
        if (mouseWasPressed(0) && this.cube_destroyed) {
